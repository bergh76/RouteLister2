...
namespace RouteLister2.Data.Migrations
{
    ...
    [Migration("20161213110912_MapRouteSetLongLat")]
    partial class MapRouteSetLongLat
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("RouteLister2.Models.Coordinat", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("RouteLister2.Models.Order", b =>
                {
                    ...
                    b.HasOne("RouteLister2.Models.RouteList", "RouteList")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("RouteLister2.Models.OrderRow", b =>
                {
                    b.HasOne("RouteLister2.Models.Order", "Order")
                        .WithMany("OrderRows")
